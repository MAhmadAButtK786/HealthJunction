...
class Nutrifitmain extends StatelessWidget {
  var height, width;

  // List of images and titles
  List imgData = [diets, calculators];
  List titles = [dietsTxt, calculatorsTxt];
    ...
    return Container(
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [
            const Color.fromARGB(255, 170,117,98),
            const Color.fromARGB(255, 170, 117, 98)
