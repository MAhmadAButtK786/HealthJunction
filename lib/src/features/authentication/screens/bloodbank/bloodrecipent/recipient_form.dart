      ...
      body: Container(
        ...
        child: SingleChildScrollView(
          child: Column(children: [
            ...
            RecipientRegistrationForm(context, _recipientRepository),
          ]),
        ),
      ),
    );
...
//Form Body
  Form RecipientRegistrationForm(
      BuildContext context, RecipientRepository _recipientRepository) {
    return Form(
      key: _formKey,
      child: Column(
        children: [
              ...
              onPressed: () async {
                ...
                if (confirmed != null && confirmed) {
                  if (_formKey.currentState!.validate()) {
                    RecepientModel recipient = RecepientModel(
          ...
          TextButton(
            ...
            onPressed: () {
              ...
              Navigator.of(context).pushReplacementNamed(
                  '/recipient_list'); // Navigate to recipient list screen
            },
          ),
        ],
      );
