...
function AddPublicBB() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await addDoc(collection(database, "Public Blood Banks"), BBPrivateData);
      alert("Public Blood Bank added successfully!");
      ...
      setBBPrivateData({
        ...
        "License Number": "",
        Name: "",
        Secter: "Public", // Resetting sector to "Private"
      });
    } catch (error) {
