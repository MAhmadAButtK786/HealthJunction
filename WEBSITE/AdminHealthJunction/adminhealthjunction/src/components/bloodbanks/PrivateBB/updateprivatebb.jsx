...
function UpdatePrivateBBLPage() {
  ...
  useEffect(() => {
    const fetchPrivateBBLData = async () => {
      const privateBBLDoc = doc(database, "Private Blood Banks", id);
  ...
  return (
    <div className="flex items-center justify-center min-h-screen p-6 bg-gradient-to-r from-red-500 to-orange-500">
      <div className="w-full max-w-lg p-8 m-4 bg-white rounded-lg shadow-md">
        <h1 className="mb-4 text-3xl font-bold text-center">Update Private Blood Bank Information</h1>
...
export default UpdatePrivateBBLPage;
