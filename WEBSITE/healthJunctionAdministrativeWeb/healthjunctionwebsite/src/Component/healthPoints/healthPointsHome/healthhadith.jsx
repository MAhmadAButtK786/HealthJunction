...
function HPHomecards() {
  return (
    <div className="p-10 text-center ">
      <blockquote className="max-w-2xl mx-auto">
        <p className="mb-4 text-lg font-semibold text-blue-800">
          قال رسول الله صلى الله عليه وسلم: "أيها عباد الله، تداووا، فإن الله لم يضع داء إلا وضع له شفاء، إلا داء واحدًا، قالوا: وما هو؟ قال: الهرم (الشيخوخة)."
        </p>
        ...
        <p className="mt-4 text-gray-600">
          (Sahih al-Bukhari, Book 76, Hadith 577)
        </p>
      </blockquote>
    </div>
  );
